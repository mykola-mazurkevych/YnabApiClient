...
public sealed record SaveTransactionWithIdOrImportId
{
    /// <summary>
    /// If specified, this id will be used to look up a transaction by its id for the purpose of updating the transaction itself.
    ...
    /// <summary>
    /// If specified, this id will be used to look up a transaction by its import_id for the purpose of updating the transaction itself.
    /// If not specified, an id should be supplied.
    /// You may not provide both an id and an import_id and updating an import_id on an existing transaction is not allowed.
    /// </summary>
